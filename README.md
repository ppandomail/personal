...
| Motivación y Liderazgo en la Gestión Pública (IN29631/18) | 01/08/2018 | 15/08/2018 | 10 | INAP |
...
* Metodologías Ágiles (Scrum, PCP, XP, DevOps)
* Análisis y Diseño de Sistemas (Yourdon, Booch, UML)
* Programación Imperativa (C, COBOL, Pascal, SQL, PL/SQL)
* Programación Objetos (Smalltalk, C++, Java, Groovy, Python)
* Programación Lógica (Prolog)
* Programación Funcional (LISP, Haskell)
* Programación Web (HTML5, CSS3, JavaScript, AngularJS, Framework Spring Boot 2)
* Programación Estadística y Generación de Gráficos (Lenguaje R)
* Testing (Frameworks: JUnit, Mockito, Selenium, Cypress, unittest, pytest, Behave, Gherkin)
...
* Herramientas de Desarrollo (Eclipse, NetBeans, Gradle)
* Herramientas de Versionado (CVS, SVN, GitHub, GitLab)
...
| Desarrollador | MHAC | 2008 | 2009 | <ul><li>Desarrollar el sistema de gestión de requerimientos "SGR"</li></ul> |
| Tester | MHAC | 2005 | 2007 | <ul><li>Diseño y ejecución manual de Casos de Prueba</li></ul> |
| Instructor | IBM | 2001 | 2001 | <ul><li>Instructor de VisualAge for Java</li></ul> |
| Desarrollador | Univ. de Morón | 2000 | 2001 | <ul><li>Desarrollo de herramientas para automatizar las gestiones de diferentes sectores de la Universidad de Morón</li></ul> |
| Desarrollador | Metrogas | 1999 | 2000 | <ul><li>Desarrollo de funcionalidades del sistema informático de Metrogas</li></ul> |
| Administrador de Base de Datos | Univ. de Morón | 1996 | 1998 | <ul><li>Administrar la base de datos de Empresas con convenios con la Universidad de Morón y pasantes</li></ul> |
...
| UNO | 06/2018 | 06/2019 | Investigador | Sistema de Información Geográfica del Partido de Merlo. Dir. Esp. Gustavo Dejean |
